...
public class GitUserService {
    ...
    public GitUser getUser(String access_token) throws Exception{
        ...
        GitUser user = new GitUser(user_id,user_name,avatar_url);
//        int notificationCount = redisUtil.lCount(json.getString("id"));
//        webSocket.sendNotification(json.getString("id"),notificationCount);
